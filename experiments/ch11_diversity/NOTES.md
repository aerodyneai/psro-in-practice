...
- **Measured result (3 seeds, λ=1, 12 iterations): the diversity bonus did NOT
  improve final exploitability on either game.** Transitive: off 0.0057±0.0006
  vs on 0.0060±0.0005. Cyclic: off 0.053±0.010 vs on 0.069±0.031 (high
  ...
  *(Transitive stds recomputed from `results/diversity_curves.csv` at
  iteration 11, n=3 seeds — the previous ±0.0005/±0.0003 numbers were
  slightly under-quoted; the manuscript already uses the CSV values.)*
